...
public class GameCore : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        allPlayers[0] = tmpPlayer; // пока нет мультиплеера
    ...
    private List<RoadLayer> SetLayers(GameObject road, bool isTop)
    {
        ...
        for (int i = 1; i <= (isTop ? 6f : 9f); i++) // разобьем дорогу на слои от верхнего к нижнему
        {
    ...
    public float HeightLayer(bool isTop)
    { return Mathf.Abs(RoadBorder(isTop, "up") - RoadBorder(isTop, "down")) / 9f; }
